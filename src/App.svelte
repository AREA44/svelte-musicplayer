<script>
	...
	function setBackground() {
		let background = `
			...
			url(./cover/${$musicList[currentSongIndex].image}) center no-repeat
		`;
...
<main bind:this={mainElement}>
	<audio
		src={"./music/"+$musicList[currentSongIndex].audio}
	...
	<div class="player">
		<div class="current-song">
			<div class="avatar">
				...
				<img src={"./cover/"+$musicList[currentSongIndex].image}>
			</div>
